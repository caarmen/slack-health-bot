...
class FitbitActivityScenario:
    ...
    input_mock_fitbit_response: dict[str, Any]
    expected_new_last_activity_log_id: str
...
activity_scenarios: dict[str, FitbitActivityScenario] = {
    ...
    "New Spinning activity, partial zones": FitbitActivityScenario(
        ...
        expected_message_pattern=(
            "New Spinning activity.*New record.*New all-time record.*Fat burn.*8.*New all-time "
            "record.*Cardio.*9.*New record"
        ),
    ),
    "New Spinning activity, full zones": FitbitActivityScenario(
            ...
            "activities": [
                {
                    ...
                    "activityName": "Spinning",
                    "activityTypeId": 55001,
                    "startTime": "2023-01-23T08:16:00.000+01:00",
                    "logId": 1235,
                    "calories": 76,
                    "duration": 665000,
                },
        ...
        expected_new_last_activity_log_id="1235",
        expected_new_activity_created=True,
        expected_message_pattern="New Spinning activity.*New all-time record.*New all-time record.*"
        + "Fat burn.*12.*New all-time record.*Cardio.*9.*New record.*Out of zone.*10.*Peak.*11.*New "
        "all-time record",
    ),
    "New Walking activity, previous walking without km": FitbitActivityScenario(
            ...
            "activities": [
                {
                    ...
                    "activityTypeId": 55001,
                    "startTime": "2023-01-23T07:16:00.000+01:00",
                    "logId": 1235,
                    "calories": 76,
                    "duration": 665000,
                    "distance": 1.119999,
        ...
        expected_new_last_activity_log_id="1235",
        expected_new_activity_created=True,
        expected_message_pattern="New Walking activity.*Duration.*New all-time record"
        + ".*Calories.*76.*New all-time record.*Distance: 1.120 km New all-time record.*"
        + "Fat burn.*12.*New all-time record.*Cardio.*9.*New record.*Out of zone.*10.*Peak.*11.*New "
        "all-time record",
    ),
            ...
            "activities": [
                {
                    ...
                    "activityName": "Walking",
                    "activityTypeId": 55001,
                    "startTime": "2023-01-23T06:16:00.000+01:00",
                    "logId": 1235,
                    "calories": 76,
                    "duration": 665000,
                    "distance": 1.119999,
            ...
            "activities": [
                {
                    ...
                    "activityTypeId": 4242,
                    "startTime": "2023-01-23T05:16:00.000+01:00",
                    "logId": 1235,
                    "calories": 76,
                    "duration": 665000,
                },
            ...
            "activities": [
                {
                    ...
                    "activityName": "Spinning",
                    "activityTypeId": 55001,
                    "startTime": "2023-01-23T04:16:00.000+01:00",
                    "logId": 1235,
                    "calories": 76,
                    "duration": 665000,
                },
            ...
            "activities": [
                {
                    ...
                    "activityName": "Spinning",
                    "activityTypeId": 55001,
                    "startTime": "2023-01-23T03:16:00.000+01:00",
                    "logId": 1235,
                    "calories": 76,
                    "duration": 665000,
                },
